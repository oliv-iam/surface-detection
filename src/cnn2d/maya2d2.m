function net = maya2d2(dataset_train)
	...
	net = residualBlock2d(net, "relu_init", num_features, "res1");
	...
	net = connectLayers(net, "res1_reluOut", "conv_mid1");

	net = residualBlock2d(net, "relu_mid1", 2*num_features, "res2");
	...
	net = addLayers(net, layers);
	net = connectLayers(net, "res2_reluOut", "conv_mid2");

	net = residualBlock2d(net, "maxpool_mid2", 4*num_features, "res3");
	...
	net = connectLayers(net, "res3_reluOut", "gap");
